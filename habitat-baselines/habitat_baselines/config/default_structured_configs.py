...
class EvalConfig(HabitatBaselinesBaseConfig):
    ...
    # FALCON evaluation data saving options
...
class HabitatBaselinesConfig(HabitatBaselinesBaseConfig):
    ...
    train_ckpt_path_dir: str = "data/checkpoints"
    ...
    # Imitation learning data saving configuration
    # modified
    save_imitation_data: bool = False
    imitation_data_dir: str = "./imitation_data"
